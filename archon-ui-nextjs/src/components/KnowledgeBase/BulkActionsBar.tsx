...
export function BulkActionsBar({
  ...
  return (
    <div className="sticky top-0 z-30 bg-blue-50 dark:bg-blue-900/20 border-b-2 border-blue-200 dark:border-blue-800">
          ...
          <div className="flex items-center gap-4">
            ...
            {processingAction && (
              <div className="flex items-center gap-2 text-sm text-blue-700 dark:text-blue-300">
                <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-blue-700 dark:border-blue-300" />
                <span>
            ...
            {!showDeleteConfirm ? (
              <>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 disabled:cursor-not-allowed rounded-lg transition-colors"
