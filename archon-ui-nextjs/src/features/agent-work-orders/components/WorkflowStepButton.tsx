...
/**
 * Workflow Step Button Component
 *
 * Visual step indicators showing completed/active/pending states with animated effects.
 * Adapted to archon-ui-nextjs patterns while preserving framer-motion animations.
 */
